...
#include <stdlib.h>
#include <kieker.h>
#include "before_received_remote_event.h"
 ...
 */
int kieker_common_record_flow_trace_before_received_remote_event_serialize(char *buffer, const int offset, const kieker_common_record_flow_trace_before_received_remote_event value) {
	int position = offset;
