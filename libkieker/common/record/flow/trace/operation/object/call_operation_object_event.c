 ...
 */
int kieker_common_record_flow_trace_operation_object_call_operation_object_event_serialize(char *buffer, const int id, const int offset, const kieker_common_record_flow_trace_operation_object_call_operation_object_event value) {
	int length = 0;
