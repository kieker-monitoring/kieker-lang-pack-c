...
#include <stdlib.h>
#include <kieker.h>
#include "call_constructor_event.h"
 ...
 */
int kieker_common_record_flow_trace_operation_constructor_call_constructor_event_serialize(char *buffer, const int offset, const kieker_common_record_flow_trace_operation_constructor_call_constructor_event value) {
	int position = offset;
