...
#include <stdlib.h>
#include <kieker.h>
#include "after_operation_event.h"
 ...
 */
int kieker_common_record_flow_trace_operation_after_operation_event_serialize(char *buffer, const int offset, const kieker_common_record_flow_trace_operation_after_operation_event value) {
	int position = offset;
