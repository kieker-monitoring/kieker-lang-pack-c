 ...
 */
int kieker_common_record_flow_trace_before_sent_remote_event_serialize(char *buffer, const int id, const int offset, const kieker_common_record_flow_trace_before_sent_remote_event value) {
	int length = 0;
