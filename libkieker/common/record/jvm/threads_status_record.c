...
#include <stdlib.h>
#include <kieker.h>
#include "threads_status_record.h"
 ...
 */
int kieker_common_record_jvm_threads_status_record_serialize(char *buffer, const int offset, const kieker_common_record_jvm_threads_status_record value) {
	int position = offset;
