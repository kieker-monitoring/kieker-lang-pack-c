...
} kieker_common_record_system_network_utilization_record;
 ...
 */
int kieker_common_record_system_network_utilization_record_serialize(char *buffer, const int offset, const kieker_common_record_system_network_utilization_record value);
